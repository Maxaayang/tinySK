...
// 定义程序中使用的常量    
#define SERVER_ADDRESS "127.0.0.1" // 服务端IP地址
...
int main()
{
    ...
    while (TRUE) {
        ...
        // 发送数据     
        send(sClient, szMessage, strlen(szMessage), 0); // sClient指明用哪个连接发送 szMessage指明待发送数据的保存地址，strlen(szMessage)ָ指明数据长度
